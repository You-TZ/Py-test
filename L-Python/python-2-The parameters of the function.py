'''
Author: your name
Date: 2022-03-10 09:09:55
LastEditTime: 2022-03-10 16:32:19
LastEditors: Please set LastEditors
Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
FilePath: \sss\python-2-The parameters of the function.py
'''
#定义函数的时候，我们把参数的名字和位置确定下来，
# 函数的接口定义就完成了。对于函数的调用者来说，只需要知道如何传递正确的参数，
...
#我们以数学题为例子，给定一组数字a，b，c……，请计算(a + b + c )二次方+ ……。
...
#当然，上面复杂的调用可以用简化的写法：
extrc = {'city': 'Shanghai','job':'doclor'}
person('cc',43,**extrc)
...
# *后面的参数被视为命名关键字参数。
#调用方式如下：
person('Adam',24,city='Beijing',job='Engineer')
...
person('Kac',34,'Beijing','Engineer')
